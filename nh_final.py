...
Original file is located at
    https://colab.research.google.com/drive/1RBLegkgxCOU9v6L1V21E4lqXiJxww2Kw
"""
...
#Гистограмма без очистки, но по трем компонентам
Hdf3T.plot(y=FunX,figsize=(18,5),title='Probably Fungi',xlim=(0,90))
