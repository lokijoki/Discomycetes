...
Original file is located at
    https://colab.research.google.com/drive/1191PVTyvvKiIPhk4-cSXv-NS_qHoBgav
...
1. У тебя будут не такие как у меня Они меняются раз от раза 
2. Для повторного запуска нужно перекомпилировать модель - иначе она переобучается до 1.0
3. можно попробовать:
- поменять местами тестовый и тренировочный наборы
- использовать гистограммы от другой фотографии
- использовать модель, обученную на одном фото для предсказаний по другому
- объединить тренировочные и тестовые наборы с двух фото   
